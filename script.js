...
document.getElementById("outerMatrix").style.display = "none"
document.getElementById("userName").style.display = "none"
document.getElementById("oppNameC").style.display = "none"
...
socket.on("find", (e) => {
    ...
    if (name != '') {
        ...
        document.getElementById("oppNameC").style.display = "block"
        document.getElementById("valueCont").style.display = "block"
        document.getElementById("loading").style.display = "none"
        document.getElementById("name").style.display = "none"
        document.getElementById("find").style.display = "none"
        document.getElementById("enterName").style.display = "none"
        document.getElementById("outerMatrix").style.display = "block"
...
function check(name, sum) {
    ...
    if ((b1 == b2 && b2 == b3) || (b4 == b5 && b5 == b6) || (b7 == b8 && b8 == b9) || (b1 == b4 && b4 == b7) || (b2 == b5 && b5 == b8) || (b3 == b6 && b6 == b9) || (b1 == b5 && b5 == b9) || (b3 == b5 && b5 == b7)) {
        ...
        sum % 2 == 0 ? document.getElementById("winner").innerHTML = "X WON !!" : document.getElementById("winner").innerHTML = "O WON !!"
